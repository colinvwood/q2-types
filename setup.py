    ...
    package_data={
        ...
        'q2_types.per_sample_sequences.tests':
            ['data/*',
             ...
             'data/collated_mags/*',
             'data/collated_mags/sample1/*',
             'data/collated_mags/sample2/*',
             'data/partitioned_mags/*',
             'data/partitioned_mags/mag1/sample1/*',
             'data/partitioned_mags/mag1/*',
             'data/partitioned_mags/mag2/sample2/*',
             'data/partitioned_mags/mag2/*'],
